...
<style>.toc {margin-top:48px;}</style>
  ...
  <div class="row">
    <div class="col-sm-9">
      <div id="colors" class="bs-docs-section">
        <?php include ("../common/elements/brand-colors.php"); ?>
      </div>
    </div>
    <div class="col-sm-3 toc" role="main">
      
<ul class="list-group">
  <li class="list-group-item"><span class="badge badge-ai">AI</span><a href="https://alaskaair.sharepoint.com/sites/BIDDT/Shared%20Documents/Alaska%20Brand%20Colors%202015%20v1.ai">Adobe Illustrator</a></li>
  <li class="list-group-item"><span class="badge badge-ps">ASE</span><a href="https://alaskaair.sharepoint.com/sites/BIDDT/Shared%20Documents/Alaska%20Brand%20Colors%202015%20v1.ase">Adobe Color Swatch</a></li> 
  <li class="list-group-item"><span class="badge badge-code">CSS</span><a href="/assets/sass-variables/colors.scss"> SASS Variables</a></li> 
</ul>
    </div>
  </div>
  <div class="row">
    <div class="col-sm-9">
      <div id="buttons" class="bs-docs-section">
        <?php include ("../common/elements/buttons.php"); ?>
      </div>
    </div>
    <div class="col-sm-3 toc" role="main">
       </div>
  ...
  <div id="hyperlinks" class="bs-docs-section">
    <?php include ("../common/elements/hyperlinks.php"); ?>
  </div>
      </div>
    <div class="col-sm-3 toc" role="main">
    </div>
  ...
  <div class="row">
    <div class="col-sm-9">  
      <div id="typography" class="bs-docs-section">
        <?php include ("../common/elements/typography.php"); ?>
      </div>
    </div>
