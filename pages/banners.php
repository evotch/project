  ...
  margin-bottom: 24px;
    ...
    <section id="banner-1-section">
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <h2 class="section-header">Banner #1</h2>
          </div>
        </div>
      </div>
      ...
      <div id="banner-1" class="container container-banner">
          ...
          <div class="row row-banner">
            ...
            <div class="col-sm-9 col-md-7" contenteditable="true">
              <div class="xsell-panel panel-default">
    ...
    <section id="banner-2-section">
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <h2 class="section-header">Banner #2</h2>
          </div>
        </div>
      </div>
    ...
    <section id="banner-3-section">
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <h2 class="section-header">Banner #3</h2>
          </div>
        </div>
      </div>
          ...
          <div class="row row-banner">
            ...
            <div class="col-sm-8 col-md-6 xsell-panel panel-navy" contenteditable="true">
              <div class="panel-body panel-body-1color">
                <div class="h3 banner-text">See more destinations and earn more rewards with Alaska Airlines and our global partners.</div>
    ...
    <section id="banner-xsell-section">
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <h2 class="section-header">Cross Sell Banners</h2>
          </div>
        </div>
      </div>
      
      <div id="banner-xsell" class="container">
