...
<div role="tabpanel">
  ...
  <ul class="nav nav-tabs dsg" role="tablist">
    ...
    <li role="presentation"><a href="#photography-SEO" aria-controls="photography-SEO" role="tab" data-toggle="tab">SEO</a></li>
    <li role="presentation"><a href="#photography-Mobile" aria-controls="photography-Mobile" role="tab" data-toggle="tab">Mobile</a></li>
  ...
  <div class="tab-content">
    ...
    <div role="tabpanel" class="tab-pane" id="photography-SEO"><div class="item">Coming Soon!</div></div>
    <div role="tabpanel" class="tab-pane" id="photography-Mobile"><div class="item">Coming Soon!</div></div>
