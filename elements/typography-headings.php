...
<!-- Modal -->
<div class="modal fade" id="typographyHeadings" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="item"><?php include ("../voice/capitalization-headings.php"); ?></div>
            ...
            <h3 id="type-headings" class="page-header secondary">Headings<button type="button" class="btn btn-success btn-xs pull-right" data-toggle="modal" data-target="#typographyHeadings">
              Voice Guidelines
            </button></h3>
