...
<<link href='/fonts/atlas.css' rel='stylesheet' type='text/css'> -->
  ...
  <link rel="stylesheet" href="http://resource.alaskaair.net/stylesheets/brand.css">
  <link rel="stylesheet" href="../../assets/css/brand.css">
  <link rel="stylesheet" href="../common/header/css/headerfooter.css">
 <style type="text/css">
  @font-face {
...
<!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
  ...
  ================================================== -->
  <body class="dsg">
<?php include ("../common/header/output/header.html"); ?>