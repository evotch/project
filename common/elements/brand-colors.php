<section id="core-brand-colors">
  ...
  <div class="alert alert-warning">V1 of brand impact is mostly about a new header and footer treatment, color changes and moving to our brand font Circular.</div>
  <h2 class="section-header">Core brand colors</h2>
  <div class="row">
<div class="col-sm-6">
