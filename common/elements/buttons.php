...
<div class="alert alert-warning">V1 of Brand Impact will only include color changes to our buttons.  It will not include the height and letter spacing changes listed.</div>
